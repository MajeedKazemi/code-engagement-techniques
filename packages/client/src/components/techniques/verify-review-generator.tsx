...
function generateQuestionsJSON(issues: {
    [key: string]: { type: string; line: number };
...
const VerifyGenerateCode: React.FC<VerifyGenerateCodeProps> = ({
    prompt,
    editor,
    taskID,
    moveOn,
                            ...
                            apiGetVerifyingReviewSimulation(
                                ...
                                .then(async (response) => {
                                    if (response.ok && editor) {
                                        ...
                                        const issues = generateQuestionsJSON(
                                            re.issues
                                        );
