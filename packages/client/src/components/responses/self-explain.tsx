...
export const SelfExplain: React.FC<SelfExplainProps> = ({
    code,
    questions,
    taskID,
}) => {
    ...
    const handleSelect = (isCorrect: boolean, index: number, text: string) => {
        ...
        const correctChoice = questions[index].choices!.find(
        ...
        <div className="self-explain-container">
            ...
            <div className="question-container">
                ...
                {questions.map((question, index) => (
                    <div
                        className={`self-explain-question-container ${
                            ...
                            {question.type.split(" ")[0] === "Short" ? (
                                ...
                                <div className="self-explain-question-content">
                                    ...
                                    {!reachedMax[index] && (
                                        <>
                                            <div className="self-explain-short-answer-container">
                                                ...
                                                />
                                                <button
                                                    className="self-explain-submit gpt-button"
                                                    onClick={() =>
                                                        handleClick(index)
                                                    }
                                                    disabled={
                                            ...
                                            {questionAnsweredTimes[index]
                                                .currentAnswer && (
                                                <div
                                                    className={`reveal-wrong-answer-container`}
                                                >
                                                    <b>You answered: </b>
                                                    <p className="reveal-wrong-answer explain-question-content">
                                                        {
                                            ...
                                            <div
                                                className={`code-self-explain-container`}
                                                id={`code-container${index}`}
                                            >
                                                {question.questionCodeLines
                                                    .split("\n")
                                                    .map((line, i) => (
                                                        <HighlightedPartWithoutTab
                                                            part={line}
                                    ...
                                    {reachedMax[index] && (
                                        <>
                                            <div
                                                className={`reveal-correct-answer-container`}
                                            >
                                                <b>Explainaton: </b>
                                                <p className="reveal-correct-answer explain-question-content">
                                                    {
                                                        question.questionCodeLinesExplained
                                                    }
                                                </p>
                                            </div>
                                            {/* show the current code the question refering to */}
                                ...
                                <div className="self-explain-question-content">
                                    ...
                                    {!reachedMax[index] && (
                                        <>
                                            <div
                                                className={`self-explain-mc-container`}
                                            >
                                                {isDisabled && (
